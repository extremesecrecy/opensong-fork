...
Protected Module REST
	...
	#tag Method, Flags = &h0
		Function ParseURI(data As String, ByRef resource As String, ByRef action As String, ByRef identifier As String, ByRef parameters As Dictionary) As Integer
		  ...
		  For Each part As String In data.Split("/")
		    ...
		    part = part.Trim
		    part = DecodeURLComponent(part, Encodings.UTF8)
		    Select Case iPart
		    Case 0
		    ...
		    Case 3
		      ...
		      Else
		        ...
		        parameters.Value(part.Left(part.InStr(":")-1)) = DecodeURLComponent(part.Mid(part.InStr(":")+1), Encodings.UTF8)
		      End Select
	...
	#tag Note, Name = Readme
		...
		For al full description of the API itself, see https://opensong.org/development/api/
