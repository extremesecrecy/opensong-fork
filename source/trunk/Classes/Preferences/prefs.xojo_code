...
Protected Module prefs
	...
	#tag Constant, Name = kBackgroundsFolder, Type = String, Dynamic = False, Default = \"backgrounds_folder", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kBibleIdentifier, Type = String, Dynamic = False, Default = \"scripture/xml/@use_filename", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kColorPaletteLoad, Type = String, Dynamic = False, Default = \"color_selector_dialog/palette/@load", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kColorPaletteSetting, Type = String, Dynamic = False, Default = \"color_selector_dialog/palette/@setting", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kColorSelectorDialog, Type = String, Dynamic = False, Default = \"color_selector_dialog", Scope = Protected
	#tag EndConstant
	...
	#tag Constant, Name = kLocaleForSearch, Type = String, Dynamic = False, Default = \"locale/search", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kLocaleForSort, Type = String, Dynamic = False, Default = \"locale/sort", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kLyricsReplaceWithSpace, Type = String, Dynamic = False, Default = \"songs/lyrics/whitespace", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kMainSplitterDockedState, Type = String, Dynamic = False, Default = \"saved_state/mainwindow/splitterdockedstate", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kMainSplitterPosition, Type = String, Dynamic = False, Default = \"saved_state/mainwindow/splitterposition", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kMainWindowState, Type = String, Dynamic = False, Default = \"saved_state/app_window", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kNDIEnableSender, Type = String, Dynamic = False, Default = \"integration/ndi/source/sender/@enable", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kPPTViewLocation, Type = String, Dynamic = False, Default = \"pptview_location", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kPresentHelperGeometry, Type = String, Dynamic = False, Default = \"present_helper_geometry", Scope = Protected
	#tag EndConstant
	...
	#tag Constant, Name = kSlideTextOutputFile, Type = String, Dynamic = False, Default = \"integration/slide_text_output/folderitem", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kSlideTextOutputOptionsBody, Type = String, Dynamic = False, Default = \"integration/slide_text_output/options/@include_body", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kSlideTextOutputOptionsEnabled, Type = String, Dynamic = False, Default = \"integration/slide_text_output/options/@enabled", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kSlideTextOutputOptionsSeparator, Type = String, Dynamic = False, Default = \"integration/slide_text_output/options/separator", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kSlideTextOutputOptionsSubTitle, Type = String, Dynamic = False, Default = \"integration/slide_text_output/options/@include_subtitle", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kSlideTextOutputOptionsTitle, Type = String, Dynamic = False, Default = \"integration/slide_text_output/options/@include_title", Scope = Protected
	#tag EndConstant
	...
	#tag Constant, Name = kUseSeparateBackgrounds, Type = String, Dynamic = False, Default = \"backgrounds_folder/@separate", Scope = Protected
	#tag EndConstant
	...
	#tag Constant, Name = kvMixEnable, Type = String, Dynamic = False, Default = \"integration/vmix/@enable", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kvMixFolder, Type = String, Dynamic = False, Default = \"integration/vmix/location", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kVmixLocation, Type = String, Dynamic = False, Default = \"vmix_folder", Scope = Protected
	#tag EndConstant
