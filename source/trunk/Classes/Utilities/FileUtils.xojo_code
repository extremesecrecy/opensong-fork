...
Protected Module FileUtils
	...
	#tag Method, Flags = &h0
		Function PathName(Extends f As FolderItem) As String
		  // FolderItem, on Windows, returns NativePath of a folder with a trailing path separator
		  // It is customary to show it without
		  ...
		  // as opposed to a windows shell (GUI, file explorer) path
