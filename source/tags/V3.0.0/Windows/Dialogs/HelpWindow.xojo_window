...
Begin Window HelpWindow
   ...
   Begin TabPanel nil_help_tabs
      ...
      Begin TextArea edt_help_lyrics
         ...
         Width           =   637
      End
      Begin HTMLViewer htm_presentation
         AutoDeactivate  =   True
         Enabled         =   True
         Height          =   401
         HelpTag         =   ""
...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  htm_presentation.LoadPage(kHeadHtml + App.T.Translate("help_topics/presentation") + kFootHtml, App.T.GetFile)
