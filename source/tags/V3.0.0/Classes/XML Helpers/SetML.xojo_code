...
Protected Module SetML
	#tag Method, Flags = &h1
		Protected Sub DrawSlide(g As Graphics, xslide As XmlNode, Style as SlideStyle)
		  ...
		  (slideType = "song" And SmartML.GetValue(xslide.Parent.Parent, "@subtype", False) = "image") Or _
		  ...
		  If hasImage Then
		    ...
		    If pic IsA Picture Then
		      ...
		      If resize = "default" Then
		        ...
		        End If
		      End If
		      If SmartML.GetValue(xslide.Parent.Parent, "@keep_aspect", False, "default") <> "default" Then
		    ...
		    For i = 1 To UBound(lines)
		      ...
		      If (g.StringWidth(lines(i)) > UsableWidth * 2) Or (multiwrap And g.StringWidth(lines(i)) > UsableWidth) Then
		        ...
		        If Not isWrapped Then
		          If x = y Then y = y + 1 // even one character does not fit on the line. Draw it anyway (avoids infinite loop)
