		...
		Sub Open()
		  ...
		  If Not T.IsLoaded Then
		    ...
		    If Not T.IsLoaded Then // Bail out...something's wrong
		      InputBox.Message "Language file '" + AppFolder.Child("OpenSong Languages").Child(lang).NativePath +_
		  ...
		  Else
		    If DocsFolder <> Nil Then
		      MsgBox  T.Translate("errors/activity_disabled", DocsFolder.NativePath + "Settings" + FileUtils.NativePathSeparator + "ActivityLog.xml")
		    Else
		      MsgBox T.Translate("errors/no_docs_folder", "")
		    End If
		    Globals.SongActivityLog = Nil
	...
	#tag Method, Flags = &h1
		Protected Function GetDocsFolder() As FolderItem
		  ...
		  If f = Nil Then
		    ...
		    If FolderName <> "" Then
		      f = GetFolderItem(FolderName, FolderItem.PathTypeNative)
		      If f = Nil Then
		        // Relative path
