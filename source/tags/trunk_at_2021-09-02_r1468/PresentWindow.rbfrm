...
#tag Events cnvSlide
	...
	#tag Event
		Sub Paint(g As Graphics, areas() As REALbasic.Rect)
		  ...
		  If inTransition Then
		    Profiler.BeginProfilerEntry "PresentWindow::Repaint Timer::Blit" + CStr(TransitionFrame)
		    ...
		    transparency = (TransitionFrames - TransitionFrame) / (TransitionFrames - TransitionFrame + 1)
		      ...
		      LastPicture.Graphics.Transparency = 100 * transparency
		    #else
		    ...
		    #if RBVersion < 2016.04 then
		      If TransitionFrames = TransitionFrame + 1 Then
