...
Implements iBible
	...
	#tag Method, Flags = &h1
		Protected Function FromRoman(strRoman as String) As integer
		  ...
		  Catch GrepErr As RegExException
	...
	#tag Method, Flags = &h0
		Sub SetDefaultPassage(ByRef Book As Integer, ByRef Chapter As Integer, ByRef FromVerse As Integer, ByRef ThruVerse As Integer)
		  If ValidateCitation(Book, Chapter, FromVerse, ThruVerse) Then Return
		  ...
		  If count > 0 Then
		    book = nums(0)
		  End If
		  If count < OT_PROTESTANT Then
		    // we don't have a full OT --> try NT instead
