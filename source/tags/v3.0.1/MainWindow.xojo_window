...
#tag WindowCode
	...
	#tag Method, Flags = &h1000
		Sub ActionSetAddSong()
		  ...
		  While f <> Nil
		    ...
		    #If TargetMacOS
		      //++
		      // AbsolutePath on MacOS (unlike Linux and Windows) does not add a trailing
		      // path separator, so the relative path is wrong. Check and correct.
		      //--
		      If Left(SongPath, 1) = "/" Then SongPath = Mid(SongPath, 2)
		      If Len(SongPath) > 0 And Right(SongPath, 1) <> "/" Then SongPath = SongPath + "/"
		    #EndIf
		      ...
		      Case "presentation"
		        ...
		        If embedFiledata.Len() > 0 Then
		          Try
		            ...
		            SmartML.SetValueFI slide_group, "@_localfilename", presFile
		          Catch
		        ...
		        Else
		          ...
		          If SongStyle <> Nil Then
		            If ActiveCustomStyle <> Nil Then
		              If Not SetML.SongStylePreferred(Nil) Then
		                SmartML.RemoveChild(slide_group, SongStyle)
	...
	#tag Method, Flags = &h21
		Private Sub LiveDisplay(slide As XmlNode, slides As XmlNodeLIst)
		  #Pragma Unused slide
	...
	#tag Method, Flags = &h0
		Function LoadSong(f As FolderItem, updateFolderSelection As Boolean = False) As Boolean
		  ...
		  If f <> Nil And f.Exists Then
		    ...
		    #If TargetMacOS Then
		      folderPath = folderPath.Left(folderPath.Len - 1)
		    #EndIf
	...
	#tag Constant, Name = kFixedFontSize, Type = Double, Dynamic = False, Default = \"", Scope = Public
