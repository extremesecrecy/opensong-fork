...
Inherits Canvas
	#tag Event
		Sub GotFocus()
		  IsMouseOver = True
		  HasFocus = True
		  If Enabled And Not Stuck Then Refresh ' False Graphics
		End Sub
	#tag EndEvent
	...
	#tag Event
		Sub Open()
		  ...
		  If App.T <> Nil Then
		    ...
		    TranslatedText = App.T.Translate(HelpTag, found)
		    If  Found Then HelpTag = TranslatedText
		  End If
		  Open
		End Sub
	#tag EndEvent
