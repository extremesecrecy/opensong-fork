   ...
   Begin TabPanel tab_general_general
      ...
      Begin GroupBox grp_settings_backgrounds
         ...
         Begin Label lbl_backgrounds_folder
            ...
            Width           =   243
         End
         Begin TextField txt_backgrounds_folder
            AcceptTabs      =   False
            Alignment       =   0
            AutoDeactivate  =   True
            AutomaticallyCheckSpelling=   False
      ...
      Begin GroupBox grp_settings_vmix
         ...
         Begin Label lbl_vmx_vmix
            ...
            Width           =   246
         End
         Begin TextField edt_applications_vmix
            AcceptTabs      =   False
            Alignment       =   0
            AutoDeactivate  =   True
            AutomaticallyCheckSpelling=   False
...
#tag WindowCode
	...
	#tag Event
		Sub Open()
		  ...
		  Dim iq As Int32
		  iq = Integer(ImageDefaults.ImageQuality)
		  iq = iq - 1
		  
		  pop_imagequality_compression.ListIndex = iq
		  ...
		  BackgroundsFolder = App.MainPreferences.GetValueFI(Prefs.kBackgroundsFolder, App.DocsFolder.Child(App.STR_BACKGROUNDS), True)
		  txt_backgrounds_folder.Text = BackgroundsFolder.NativePath
...
#tag Events btn_ok
	#tag Event
		Sub Action()
		  ...
		  App.MainPreferences.SetValueFI(Prefs.kVmixLocation, VmixLocation)
	...
	#tag Event
		Sub Action()
		  ...
		  If targetFolder <> Nil Then
		    txt_backgrounds_folder.Text = targetFolder.NativePath
