...
Implements iBible
	...
	#tag Method, Flags = &h21
		Private Function GetIndexFolder(bibleFile As FolderItem) As FolderItem
		  ...
		  Dim indexFilename As String = bibleFile.NameWithoutExtension + ".ind"
		  ...
		  Dim preferredLocation As FolderItem
		  
		  locations = BibleFactory.SearchFolders
		  
		  If locations.Ubound < 0 Then Return Nil
		  
		  preferredLocation = BibleFactory.ScriptureFolder
		  ...
		  For i = 0 To locations.Ubound
		    ...
		    Try
		      ...
		      indexFolder = indexFolder.Child("indexes")
		      If Not indexFolder.Exists Then Continue
		  ...
		  indexFolder = preferredLocation
		  If indexFolder Is Nil Then Return Nil
		  If Not indexFolder.Exists Then Return Nil
		  indexFolder = indexFolder.Child("indexes")
		  If Not indexFolder.exists Then
		    Try 
		      indexFolder.CreateFolder
	...
	#tag Method, Flags = &h1
		Protected Function getZefVerseText(VerseNode As XmlNode, recursing As Boolean = False) As String
		  ...
		  // collaps stretched of whitespace to a sngle space
		  re = New RegEx
		  re.SearchPattern = "\s+"
		  re.ReplacementPattern = " "
		  re.Options.ReplaceAllMatches = True
