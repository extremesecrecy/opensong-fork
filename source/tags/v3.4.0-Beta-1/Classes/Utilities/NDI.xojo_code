...
Protected Class NDI
	...
	#tag Method, Flags = &h21
		Private Sub Destructor()
		  ...
		  #If Not (TargetMacOS And TargetARM)
	...
	#tag Property, Flags = &h21
		Private Shared FindInstance As Ptr
	#tag EndProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  If mNDICriticalSection = Nil Then mNDICriticalSection = New CriticalSection
	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			...
			End Get
		#tag EndGetter
		Private Shared ndi_send_instance As Ptr
	#tag EndComputedProperty
	...
	#tag Constant, Name = NDILIB, Type = String, Dynamic = False, Default = \"", Scope = Private, CompatibilityFlags = (TargetDesktop and (Target32Bit or Target64Bit))
		...
		#Tag Instance, Platform = Mac OS, Language = Default, Definition  = \"libndi.4.dylib"
		#Tag Instance, Platform = Linux, Language = Default, Definition  = \"libndi.so.4.5.3"
	#tag EndConstant
