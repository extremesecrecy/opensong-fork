...
Protected Module OpenSongUtils
		...
		Sub InitPageSetupFromSettings(ByRef ps As PrinterSetup, PrintSettings As XmlDocument)
		  #If TargetWin32
		    ...
		    Dim convFact As Double
		      ...
		      Dim dm As DEVMODE_A
		    #elseIf RBVersion > 2017.02
		      Dim dm As DEVMODE_W
		    #else
		      #pragma Error "Please find out what type of DEVMODE structure your compiler returns."
		    #endif
		    s = ps.SetupString
	...
	#tag Method, Flags = &h0
		Function ToString(Extends r As REALbasic.Rect) As String
		  Return Join(Array(Cstr(r.left), CStr(r.top), CStr(r.Width), CStr(r.Height)), ", ")
		End Function
	#tag EndMethod
