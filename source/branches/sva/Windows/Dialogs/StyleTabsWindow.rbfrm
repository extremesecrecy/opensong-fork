   ...
   Begin GroupBox grp_tabs
      ...
      Begin GroupBox grp_tabs_properties
         ...
         Begin PushButton btn_apply
            ...
            Width           =   80
         End
         Begin Label lbl_tabs_properties
            AutoDeactivate  =   True
            Bold            =   ""
            DataField       =   ""
            DataSource      =   ""
...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  #If TargetWin32
		    lbl_tabs_properties.Text = grp_tabs_properties.Caption
		    lbl_tabs_properties.Transparent = True
		    lbl_tabs_properties.TextFont = grp_tabs_properties.TextFont
		    lbl_tabs_properties.TextSize = grp_tabs_properties.TextSize
		    grp_tabs_properties.Caption = ""
		  #Else
		    lbl_tabs_properties.Visible = False
		  #EndIf
