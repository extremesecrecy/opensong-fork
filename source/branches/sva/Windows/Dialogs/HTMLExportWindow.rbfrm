		...
		Function ShowDialog(exportPrefs As HTMLExportOptions, within As Window = Nil) As Boolean
		  ...
		  Else
		    If prefs.StyleSheet <> Nil Then
		      edt_cssfile.Text = prefs.StyleSheet.AbsolutePath
		    End If
		  End If
		  
		  If prefs.OutputFolder <> Nil Then
		    edt_outdir.Text = prefs.OutputFolder.AbsolutePath
		  End If
	...
	#tag Event
		Sub TextChange()
		  ...
		  Else
		    ...
		    Else
		      Try
		        prefs.StyleSheet = GetFolderItem(edt_cssfile.Text)
		        If prefs.StyleSheet <> Nil Then
		          prefs.TargetStyleSheetName = prefs.StyleSheet.Name
		        End If
		      catch
...
#tag Events edt_outdir
	#tag Event
		Sub TextChange()
		  ...
		  Else
		    Try
		      prefs.OutputFolder = GetFolderItem(edt_outdir.Text)
