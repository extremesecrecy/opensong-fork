	...
	#tag Method, Flags = &h1
		Protected Function XDocFromFile(f As FolderItem) As XmlDocument
		  ...
		  Catch err As XmlException
		    ...
		    ErrorString = TranslateMessage("smartml/xml_exterror", "XmlException from LoadXML on file %s %s", f.AbsolutePath, msg, "")
		    '--
		    Return Nil
		  End Try
		Catch ex
