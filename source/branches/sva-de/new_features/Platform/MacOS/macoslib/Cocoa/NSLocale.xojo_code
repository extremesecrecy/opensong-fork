...
Inherits NSObject
	...
	#tag Method, Flags = &h1000
		Function LocalizedStringForLocaleIdentifier(aString as String) As String
		  
		  #if TargetMacOS
		    Declare Function localizedString Lib CocoaLib Selector "localizedStringForLocaleIdentifier:" (obj_id As Ptr, aString As CFStringRef) As CFStringRef
		    
		    Return localizedString(Self, aString)
